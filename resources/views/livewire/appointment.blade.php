                                ...
                                <form wire:submit.prevent="schedule">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control @error('reason') is-invalid @enderror"
                                            name="reason" wire:model="reason" id="reason">
                    ...
                    <div class="modal-body">
                        <div class="col-lg-12 m-auto">
                            <div class="text-center">
                                ...
                                <br>
                                <p>Te enviamos un correo para que confirmes tu cita</p>
                                <br>
                                @error('sendSuccess')
                                    @if ($message != '')
                                ...
                                @enderror
                                <br>
                                <button type="button" class="btn btn-primary" wire:click="resendEmail">Volver enviar
                                    email</button>
