                ...
                @if(!empty($selectedSymptoms))
                    <div class="d-flex flex-wrap gap-2 my-3">
                        @foreach($selectedSymptoms as $s)
                            <span class="inline-flex items-center gap-2 px-3 py-1 rounded-full mt-1 bg-gray-200 text-slate-700 shadow-sm">
                                ...
                                <button
                                    ...
                                    wire:click="removeSymptom('{{ $s['code'] }}')"
                            ...
                            <div class="m-3">
                                <div class="alert alert-warning" role="alert">
                                    <div class="text-muted small">
                                        No hay propuestas para mostrar. Añade síntomas y haz clic en "Buscar" para obtener sugerencias.
                                    </div>
                                </div>
                            </div>
                        @endforelse
